...
function LadderGame() {
  ...
  // const test = () => {
  //   const rrrr = "younggyun"
  //   const url = `/admin/detail/${rrrr}`;
  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-20">
        ...
        <button className="button button-first">Back</button>
        <button className="button button-second ml-11">Start</button>
